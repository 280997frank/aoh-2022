...
interface IProfessionalisingArmyTraining {
  data: IIntroductionItem[];
}

const ProfessionalisingArmyTrainingContent: React.FC<
  IProfessionalisingArmyTraining
> = ({ data }) => {
...
export default ProfessionalisingArmyTrainingContent;
